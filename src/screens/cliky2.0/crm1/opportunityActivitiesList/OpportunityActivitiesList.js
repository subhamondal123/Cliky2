...
class OpportunityActivityList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            leadactivitiesList: [],
    ...
    _onLoad = async () => {
        ...
        // if (this.props.route.params.type == "past") {
    ...
    listView = (item, key) => {
        return (
            <View style={styles.listDataView} key={key}>
                <Text style={[styles.textList, { flex: 0.3 }]}>{item.item.activityTypeName}</Text>
                <Text style={[styles.textDate, { textAlign: 'center', flex: 0.3 }]}>{DateConvert.formatYYYYMMDD(item.item.dueDate)}</Text>
                <Text style={[styles.nameText, , { flex: 0.2 }]}>{item.item.firstName + " " + item.item.lastName}</Text>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={{ flex: 0.6 }}>
                            <View style={{ flexDirection: 'column' }}>
                                <Text style={{ color: Color.COLOR.BLUE.VIOLET_BLUE, fontSize: FontSize.SM, fontFamily: FontFamily.FONTS.INTER.BOLD }}>Opportunity ActivityList</Text>
                            </View>
                        </View>
                        <View style={{ flex: 0.2 }} />
                    </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(OpportunityActivityList);
