...
import { modifyLocationMappedData, validateData } from "./function";
...
class CurrentAndCompetitor extends React.Component {
    ...
    _onChangeProductDesc = (value, key) => {
        ...
        this.state.allPageData.productData[key].productDesc = value;
        this.setState({
            allPageData: this.state.allPageData
        })
    }
    ...
    _onSave = () => {
        ...
        for (let i = 0; i < allArr.length; i++) {
            let modObj = {
                "prodHierarchyTypeId": allArr[i].hierarchyTypeId,
                "prodHierarchyDataId": allArr[i].hierarchyDataId,
                "productArr": allArr[i].productArr,
                productName: allArr[i].selectedProductName.id ? allArr[i].selectedProductName.id : "",
                desc: allArr[i].productDesc ? allArr[i].productDesc : "",
                status: "",
                competitorType: allArr[i].isCurrentlyCheck ? "0" : "1"
            };
