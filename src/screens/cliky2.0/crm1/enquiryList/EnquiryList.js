...
import { AssignedModal, CheckBox, DropdownInputBox, EditAndDeleteModal, FilterModal, LottyViewLoad, Modal, NoDataFound } from "../../../../shared";
...
class EnquiryList extends React.Component {
  ...
  _load = async () => {
    ...
    // this.onCheckPermission(moduleSettingData);
      ...
      if (responseData.status === ErrorCode.ERROR.ERROR_CODE.SUCCESS) {
        if (this.state.pageNum == 0) {
          ...
          if (enquiryData == null || enquiryData == undefined) {
            ...
            await StorageDataModification.crmEnquiryListData(enquiryListData, "store");
        ...
        if (this.state.pageNum == 0) {
          await StorageDataModification.crmEnquiryListData({}, "clear");
          this.setState({
            pageNum: 0,
            limit: 10,
            totalDataCount: 0,
      ...
      <SafeAreaView style={CustomStyle.container}>
        <React.Fragment>
          ...
          {this.state.pageLoader ?
            ...
            <React.Fragment>
              {this.listHeaderSection()}
              {this.state.showHideCheckBox && this.state.enquiryList.length > 0 ? <React.Fragment>
