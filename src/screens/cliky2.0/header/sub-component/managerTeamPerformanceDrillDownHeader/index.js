...
class TeamPerformanceDrillDownHeader extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            headerText: "",
                ...
                <View style={styles.gamificationMainView}>
                    ...
                    {actionItem.shareVisible ?
                        <TouchableOpacity style={{ marginHorizontal: 10 }} onPress={() => this.onShared()}>
                            {/* <SvgComponent svgName={"share"} strokeColor={"#1F2B4D"} /> */}
...
export default TeamPerformanceDrillDownHeader;