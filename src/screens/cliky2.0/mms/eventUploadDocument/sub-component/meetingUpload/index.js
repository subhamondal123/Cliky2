...
const imageArr = [
    {
        "fileName": "rnimagepickerlibtempaffecfcaf1666374647933.jpg",
        "lattitude": 22.4051124,
        "longitude": 88.2765032,
        "orgfilename": "/images/rnimagepickerlibtempaffecfcaf1666374647933.jpg"
    },
    {
        "fileName": "rnimagepickerlibtempdfacdadbcf1666374663351.png",
        "lattitude": 22.4051124,
        "longitude": 88.2765024,
        "orgfilename": "/images/rnimagepickerlibtempdfacdadbcf1666374663351.png"
    },
    {
        "fileName": "rnimagepickerlibtempdfacdadbcf1666374663351.png",
        "lattitude": 22.4051124,
...
class MeetingUpload extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            pageLoader: true,
    ...
    _load = async () => {
        // let modifyImageResponse = modImageArr(imageArr)
    ...
    _modifyImgShowingArr = (data) => {
        this.state.allImgShow = _modifyAddDataArr(data);
                    ...
                    <View style={styles.mainBody}>
                        {this.state.pageLoader ?
                            <View style={{ height: Dimension.height / 1.5, marginTop: 30 }}>
                                <Loader backgroundColor={"#070457"} />
                            </View>
                            :
                            <>
                                <View style={styles.mainHeadBody}>
                                    <View style={styles.headerLogoSec}>
                                        <Image source={ImageName.MEETING_DOC_MAIN_LOGO} style={styles.mainHeaderLogo} />
                                    </View>
                                    <View>
                                ...
                                <View style={styles.arraySection}>
                                    ...
                                    <View style={styles.photoSec}>
                                        {console.log("this.state.allImgShow----", JSON.stringify(this.state.allImgShow))}
                                                        ...
                                                        {item.map((item1, key1) => (
                                                            <React.Fragment key={key1}>
                                                                <View style={styles.flexANdMarginView}>
                                                                    {console.log("item1.fileName----", item1.fileName)}
...
export default connect(mapStateToProps, mapDispatchToProps)(MeetingUpload);