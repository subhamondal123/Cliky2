...
import { DynamicCategoryTab, LmsActivitySelectionTab, LmsInfluencerActivitySelectionTab, ProfileSec } from '../../../../pageShared'
...
export default class InfluencerActivityDetails extends Component {
    ...
    onUserActivitySelectionSection = () => {
        return (<LmsInfluencerActivitySelectionTab {...this.props} onClickItem={() => this.onSelectTab()} />);
    }
