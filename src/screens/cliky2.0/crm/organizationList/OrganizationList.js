  ...
  _apiCallRes = async () => {
    ...
    if (responseData) {
      if (responseData.status === ErrorCode.ERROR.ERROR_CODE.SUCCESS) {
        ...
        if (organizationListData.organizationList.length == 0) {
          ...
          <View style={[styles.blueBox]}>
            <View style={styles.blueViewFlex}>
              <View style={styles.homeCircel}>
                <Image source={{ uri: App_uri.IMAGE_URI + "/images/business.jpg" }} style={styles.homeLogo} />
              </View>
              <TouchableOpacity style={{ marginLeft: "5%", flex: 1 }} activeOpacity={1} onPress={() => this.onShowHideData(item)}>
                ...
                <Text style={styles.textDealer}>{item.contactName}</Text>
              </TouchableOpacity>
            ...
            <View>
              ...
              <View style={[styles.textFlexView]}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.textVisites}>{item.website}</Text>
              ...
              <View style={[styles.textFlexView, { borderBottomWidth: 0 }]}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.textVisites}>{'\u20B9' + item.anualRevenue}</Text>
                </View>
