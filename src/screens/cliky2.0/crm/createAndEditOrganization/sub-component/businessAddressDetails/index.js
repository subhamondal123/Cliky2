...
class BusinessAddressDetails extends React.Component {
    ...
    _onSave = () => {
        let reqData = {
            "address": this.state.allPageData.businessAddress ? this.state.allPageData.businessAddress : "",
            "locationArr": this.state.allPageData.orgLocationData,
            "hierarchyTypeId":this.state.allPageData.orgLocationData.hierarchyTypeId,
            "hierarchyDataId": this.state.allPageData.orgLocationData.hierarchyDataId,
