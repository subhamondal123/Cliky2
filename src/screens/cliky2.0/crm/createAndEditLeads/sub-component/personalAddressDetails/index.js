...
class PersonalAddressDetails extends React.Component {
    ...
    _onSave = () => {
        let reqData = {
            "locationHierarchyDataId": this.state.allPageData.locationData.hierarchyDataId,
            "locationHierarchyTypeId": this.state.allPageData.locationData.hierarchyTypeId,
        }
