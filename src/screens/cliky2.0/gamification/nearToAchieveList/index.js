...
class GamificationNearToAchieveList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            toolTip: false,
    ...
    storeInitialData = async () => {
        let topGainData = await StorageDataModification.gamificationNearToAchieveList({}, "get");
    ...
    fetchListData = async (dataReq) => {
        let responseData = await MiddlewareCheck("nearToAchieveList", dataReq, this.props);
        if (responseData) {
            if (responseData.status === ErrorCode.ERROR.ERROR_CODE.SUCCESS) {
                if (this.state.pageNum == 0) {
                    ...
                    if (topGainData == null || topGainData == undefined) {
                        ...
                        await StorageDataModification.gamificationNearToAchieveList(topGainListData, "store");
                ...
                if (this.state.pageNum == 0) {
                    await StorageDataModification.gamificationNearToAchieveList({}, "get");
                    this.setState({
                        pageNum: 0,
                        limit: 10,
                        totalDataCount: 0,
    ...
    changeConversionStatus = async (value) => {
        ...
        //...............
        let pjpData = await StorageDataModification.gamificationNearToAchieveList({}, "get");
        ...
        await StorageDataModification.gamificationNearToAchieveList(pjpData, "store");
    }
            ...
            <View>
                <View style={styles.flexRow}>
                    ...
                    <View style={styles.listMainView}>
                        <Text style={styles.listheaderText}>{item.description}</Text>
                ...
                {this.state.pageLoader ?
                    ...
                    <React.Fragment>
                        <View style={styles.mainView}>
                            ...
                            <Text style={styles.textTopGain}>Near to Achieve</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(GamificationNearToAchieveList);
