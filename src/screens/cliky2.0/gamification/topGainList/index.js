...
import { CheckBox, NoDataFound } from "../../../../shared";
...
class GamificationTopGainList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            toolTip: false,
    ...
    storeInitialData = async () => {
        let topGainData = await StorageDataModification.gamificationTopGainList({}, "get");
    ...
    fetchListData = async (dataReq) => {
        let responseData = await MiddlewareCheck("topGainForUserList", dataReq, this.props);
            ...
            if (responseData.status === ErrorCode.ERROR.ERROR_CODE.SUCCESS) {
                if (this.state.pageNum == 0) {
                    ...
                    if (topGainData == null || topGainData == undefined) {
                        ...
                        await StorageDataModification.gamificationTopGainList(topGainListData, "store");
                ...
                if (this.state.pageNum == 0) {
                    await StorageDataModification.gamificationTopGainList({}, "get");
                    this.setState({
                        pageNum: 0,
                        limit: 10,
                        totalDataCount: 0,
    ...
    changeConversionStatus = async (value) => {
        ...
        //...............
        let pjpData = await StorageDataModification.gamificationTopGainList({}, "get");
        ...
        await StorageDataModification.gamificationTopGainList(pjpData, "store");
    }
            ...
            <View>
                <View style={styles.flexRow}>
                    <View style={[styles.circelBackground]}>
                        <Image source={ImageName.YELLOW_COIN_ICON} style={styles.circelImg} />
                    </View>
                    <View style={styles.listMainView}>
                        <Text style={styles.listheaderText}>You have earned</Text>
            ...
            <SafeAreaView style={styles.container}>
                ...
                {this.state.pageLoader ?
                    <View style={{ marginTop: 30, marginHorizontal: 10 }}>
                        <SkeletonPlaceholder>
                            <View style={{ height: 60, borderRadius: 10, marginBottom: 25 }} />
                    ...
                    <React.Fragment>
                        <View style={styles.mainView}>
                            <View style={styles.likeSec}>
                                <View style={styles.likeCircel}>
                                    <Image source={ImageName.WHITE_LIKE_LOGO} style={styles.whiteLikeImg} />
                                </View>
                                <View style={{ flexDirection: 'column', marginLeft: '5%', flex: 1 }}>
                                    <Text style={styles.textLevel}>{this.props.route.params.userData.levelName}</Text>
                                    <Text style={styles.pepoleNumberText}>{this.props.route.params.userData.congratsCount}  <Text style={styles.peopleText}>People Congratulate for</Text></Text>
                                </View>
                            ...
                            <Text style={styles.textTopGain}>Top Gain</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(GamificationTopGainList);
