...
export function validateData(data) {
    ...
    else if (data.fromPoint == undefined || data.fromPoint == null || data.fromPoint == "") {
        Toaster.ShortCenterToaster("Please Enter From Point");
        errCounter++;
    }
    else if (data.toPoint == undefined || data.toPoint == null || data.toPoint == "") {
        Toaster.ShortCenterToaster("Please Enter To Point");
        errCounter++;
    }
    else if (data.expenseUnitId == undefined || data.expenseUnitId == null || data.expenseUnitId.length == 0) {
