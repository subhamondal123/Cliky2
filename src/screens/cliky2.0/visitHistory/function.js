...
export function modifyListData(data, selectItem) {
    if (data) {
        for (let i = 0; i < data.length; i++) {
            ...
            if (data[i].visitto == undefined || data[i].visitto == null || data[i].visitto == "N/A" || data[i].visitto == "NA" || data[i].visitto == "na") {
                data[i].visitto = "";
            } else {
                data[i].visitto = data[i].visitto;
            }
            if (data[i].shopName == undefined || data[i].shopName == null || data[i].shopName == "N/A" || data[i].shopName == "NA" || data[i].shopName == "na") {
                data[i].shopName = "";
            } else {
                data[i].shopName = data[i].shopName;
            }
            if (data[i].organizationName == undefined || data[i].organizationName == null || data[i].organizationName == "N/A" || data[i].organizationName == "NA" || data[i].organizationName == "na") {
            ...
            if (data[i].orderDetails == undefined || data[i].orderDetails == null) {
                data[i].orderDetails = [];
            } else {
                data[i].orderDetails = getOrderDetails(data[i].orderDetails);
            }
...
export function getOrderDetails(data) {
    if (data) {
        for (let i = 0; i < data.length; i++) {
            if (data[i].orderNumber == undefined || data[i].orderNumber == null) {
                data[i].orderNumber = "";
            } else {
                data[i].orderNumber = data[i].orderNumber;
            }
            ...
            if (data[i].unitShort == undefined || data[i].unitShort == null) {
                ...
                data[i].unitShort = data[i].unitShort;
            }
            ...
            if (data[i].approvedQuantity == undefined || data[i].approvedQuantity == null) {
                data[i].approvedQuantity = "";
            } else {
                data[i].approvedQuantity = data[i].approvedQuantity;
            }
            ...
            if (data[i].orderDate == undefined || data[i].orderDate == null) {
                data[i].orderDate = "";
            } else {
                data[i].orderDate = data[i].orderDate;
            }
        }
    }
    return data;
...
export function dateModArr(inputJson) {
    ...
    inputJson.forEach(item => {
        ...
        const dayKey = DateConvert.getDDthMonthNameYYYYformat(item.actualDate).month + " " + DateConvert.getDDthMonthNameYYYYformat(item.actualDate).year;
...
export function getMaxId(arrData) {
    // let result = [{id:5},{id:10},{id:2}]
