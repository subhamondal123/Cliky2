...
class UserActivitySelectionSection extends Component {
    constructor(props) {
        super(props);
        this.state = {
            dayData: [],
    ...
    onLoad = async () => {
        let dayArrData = await storageTabData(this.state, this.props)
        this.setState({ dayData: dayArrData })
    ...
    selectItem = async (itemData, key) => {
        console.log("item datat",itemData)
...
export default UserActivitySelectionSection;