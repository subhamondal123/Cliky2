...
export default class AllOrderHistoryFilter extends Component {
    constructor(props) {
        super(props)
        this.state = {
            customerTypeArr: [],
    ...
    onApply = () => {
        let data = { selectedRecordType: this.state.selectedRecordType, selectedSubordinateId: this.state.selectedSubordinateObj, fromDateObj: this.state.fromDateObj, toDateObj: this.state.toDateObj }
